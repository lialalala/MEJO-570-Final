...
```{r}
#jrotc_airforce <- read.csv("INSERT AIR FORCE SPREADSHEET")

#jrotc_raw <- cbind(jrotc_raw_first_half, jrotc_airforce) #Make sure the columns have the same names
```
# b) Format for tidygeocoder

```{r}
jrotc_for_geo <- jrotc_raw_first_half %>%
